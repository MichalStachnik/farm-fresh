...
const Farm = ({
  ...
  const initialState = searchParams.farm ? JSON.parse(searchParams.farm) : {};
  // const { slug } = params;
  ...
  const handleProductChange = (
    ...
    const newProducts = products.map((p) => {
      if (p.name === name) return newProduct;
      return p;
    });
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2">
                      <input
                        value={product.name}
                        onChange={(e: ChangeEvent<HTMLInputElement>) =>
                          handleProductChange(e, 'name', product.name)
                        }
                        type="text"
                        name="first-name"
                        id="first-name"
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2">
                      <input
                        value={product.about}
                        onChange={(e: ChangeEvent<HTMLInputElement>) =>
                          handleProductChange(e, 'about', product.name)
                        }
                        type="text"
                        name="last-name"
                        id="last-name"
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2">
                      <input
                        value={product.price}
                        onChange={(e: ChangeEvent<HTMLInputElement>) =>
                          handleProductChange(e, 'price', product.name)
                        }
                        type="number"
                        name="last-name"
                        id="last-name"
